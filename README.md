...
Simulating this baseline random trader 20,000 times gave higher density coverage of the randomly chosen start dates, improving the coverage of any temporal variances in the dataset. Additionally, these simulations improved the confidence in the average, median, and chance of a negative return metrics, since all these metrics asymptotically approach their true values. On average, a random trader is expected to make 5.5% returns and has a roughly 40.4% chance of negative returns after 180 days. Sampling from this distrobution after 1 year, the expected returns are about 13% and the chance of negative return reduces to about 33%, while after 5 years expected returns are about 88% and the chance of negative returns reduces to about 18%.
