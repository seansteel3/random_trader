...
Simulating this baseline random trader 20,000 times gave higher density coverage of the randomly chosen start dates, improving the coverage of any temporal variances in the dataset. Additionally, these simulations improved the confidence in the average, median, and chance of a negative return metrics, since all these metrics asymptotically approach their true values. On average, a random trader is expected to make 5.5% returns and has a roughly 40.4% chance of negative returns after 180 days. Sampling from this distrobution after 1 year, the expected returns are about 11% and the chance of negative return reduces to about 33%, while after 5 years

![image](https://user-images.githubusercontent.com/67161057/187761224-afb1226a-70e0-442a-9010-fbc0ba96a01f.png)

![image](https://user-images.githubusercontent.com/67161057/188165981-b24af7c5-38fd-4a4c-95bf-37b3707ea82d.png)
